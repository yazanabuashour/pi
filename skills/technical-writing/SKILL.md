...
**Explanation: understanding and why.** One bounded topic, readable away from the product. Each title should tolerate an implicit "About..." in front. Anchor on a real why question. Give context: design decisions, history, constraints, alternatives. Distinguish facts from judgments and explain recommendations.
...
- Split sentences that obscure an action, condition, or thought.
...
- Split sentences when clauses or asides obscure the point.
...
- Follow repository and language formatting conventions in code snippets. Write real paths and real symbols. Make every count or tree claim true at the commit that lands it, and include the command that regenerates it.
